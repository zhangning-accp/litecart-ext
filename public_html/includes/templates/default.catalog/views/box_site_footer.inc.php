<style type="text/css">
    ...
    #footer_social ul.social-icons li.email {
        display: block;
        height: 100%;
        width:110px;
        float: left;
    ...
    #footer_social ul.social-icons li:hover {
...
<div id="footer_wrapper">
    ...
    <div id="footer_social">
        ...
        <ul class="social-icons">
            <li class="email"><a href="https://x.e.champssports.com/ats/show.aspx?cr=100232&amp;fm=84" data-action="open-email-overlay" target="_blank" title="Sign Up to Receive E-mails"></a></li>
            <li class="facebook"><a href="https://www.facebook.com/champssports" target="_blank" title="Like Champs Sports on Facebook"></a></li>
            <li class="twitter"><a href="https://twitter.com/champssports" target="_blank" title="Follow Champs Sports on Twitter"></a></li>
            <br>
            <li class="instagram"><a href="http://instagram.com/champssports" target="_blank" title="Follow Champs Sports on Instagram"></a></li>
            <li class="youtube"><a href="http://www.youtube.com/user/ChampsSports" target="_blank" title="Subscribe Champs Sports on YouTube"></a></li>
            <li class="snapchat"><a href="https://www.snapchat.com/add/champssports" target="_blank" title="Add Champs Sports on Snapchat"></a></li>
        </ul>
    </div>
    <div id="footer_big_links">
        <ul>
            <li>
                ...
                <a href="https://x.e.champssports.com/ats/show.aspx?cr=100232&amp;fm=84" data-action="open-email-overlay" target="_blank" title="Sign Up For Email Exclusives"><img src="/ns/common/champssports/images/email-icon.png" alt="">Sign up now</a>
            </li>
            <li>
                <h3>Champs Sports<br>Gift Cards</h3>
                <p>Never Expires/No Fees. Even if the card says otherwise.</p>
                <a href="https://www.champssports.com/Gift-Cards/" manual_cm_sp="Footer2-_-Stayconnected-_-Champssportsgiftcards" title="Champs Sports Gift Cards"><img src="/ns/common/champssports/images/giftcard-icon.png" alt="">Learn More</a>
            </li>
            <li>
                <h3>Contact Us</h3>
                <p>Available 24 hours a day,<br>7 days a week.</p>
                <a href="mailto:store@email.com" style="color:#FFFFFF;">store@email.com</a>
<!--                <a href="https://www.champssports.com/content/feedback" manual_cm_sp="Footer2-_-Stayconnected-_-Contactus" title="Contact Us 1.800.991.6813"><span class="phone-number">1.800.991.6813</span></a>-->
                <p></p>
            </li>
            <li>
                <h3>Live Chat</h3>
                <a title="Live Chat" href="#" onclick="cmCreateConversionEventTag('Live Chat',1,'Chat',0); cmCreateConversionEventTag('Live Chat',2,'Chat',0); startChatAndCobrowse(gIChannel, gServer, gAttachedData, prefillValues, agentOnlyValues, bEnterOnQueuePage); return false;">Chat Now</a>
            </li>
        </ul>
    </div>

    <div id="footer_links">
        <a href="javascript:return;" manual_cm_sp="Footer2-_-Textlinks-_-Orderinghelp" title="Ordering Help">Ordering Help</a>
        <a href="javascript:return;" manual_cm_sp="Footer2-_-Textlinks-_-Shippinginfo" title="Shipping Info">Shipping Info</a>
        <a href="javascript:return;" manual_cm_sp="Footer2-_-Textlinks-_-Sizinghelp" title="Sizing Help">Sizing Help</a>
        <a href="javascript:return;" manual_cm_sp="Footer2-_-Textlinks-_-Returnsandexchanges" title="Returns &amp; Exchanges">Returns &amp; Exchanges</a>
        <a href="javascript:return;" manual_cm_sp="Footer2-_-Textlinks-_-Affiliates" title="Affiliates">Affiliates</a>
        <a href="javascript:return;" manual_cm_sp="Footer2-_-Textlinks-_-Storelocator" title="Champs Sports Store Locator">Store Locator</a>
        ...
        <a href="javascript:return;" manual_cm_sp="Footer2-_-Textlinks-_-Privacystatement" title="Privacy Statement">Privacy Statement</a>
        <a href="javascript:return;" manual_cm_sp="Footer2-_-Textlinks-_-Termsofuse" title="Terms of Use"> Terms of Use</a>
    ...
    <p style="color: #FFFFFF;font-weight: bold;text-align: center">© 2018 Footlocker.com, Inc. All rights reserved. Prices subject to change without notice. Products shown may not be available in our stores. (<a style="color:#b2906a;" href="javascript:return;">more info</a>).</p>
